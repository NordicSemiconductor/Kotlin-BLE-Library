...
### Dependency
```Groovy
implementation 'no.nordicsemi.android.kotlin.ble:client:1.0.7'
```
...
### Dependency
```Groovy
implementation 'no.nordicsemi.android.kotlin.ble:advertiser:1.0.7'
```
...
### Dependency
```Groovy
implementation 'no.nordicsemi.android.kotlin.ble:server:1.0.7'
```
