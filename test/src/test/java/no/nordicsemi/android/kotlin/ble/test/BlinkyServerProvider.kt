...
class BlinkyServerProvider @Inject constructor(
    private val scope: CoroutineScope,
) {

    private val buttonState = MutableStateFlow(DataByteArray.from(0x00))

    fun start(context: Context, serverDevice: MockServerDevice) = scope.launch {
        ...
        advertiser.advertise(advertiserConfig, serverDevice) //Start advertising
            .cancellable()
